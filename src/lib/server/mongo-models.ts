...
const AppConfigSchema = new Schema(
  {
    ...
    dashboardPopupEnabled: { type: Boolean, default: false },
    dashboardPopupTitle: { type: String, default: '' },
    dashboardPopupBody: { type: String, default: '' },
    dashboardPopupPrimaryLabel: { type: String, default: '' },
    dashboardPopupPrimaryUrl: { type: String, default: '' },
    dashboardPopupSecondaryLabel: { type: String, default: '' },
    dashboardPopupSecondaryUrl: { type: String, default: '' },
    dashboardPopupUpdatedAt: { type: Number, default: 0 },
  },
